...
public class Auth0AccessTokenFactory implements Supplier<AccessTokenFactory> {
    ...
    public Auth0AccessTokenFactory(
            OidcAuthClientAuth0Properties properties,
    ...
    public AccessTokenFactory get() {
        return new AccessTokenFactoryBuilder()
                ...
                .withMustRefreshThreshold(
                        properties.getMustRefreshThreshold() != null
                                ? properties.getMustRefreshThreshold()
                                : mustRefreshThreshold)
                .withShouldRefreshThreshold(
                        properties.getShouldRefreshThreshold() != null
                                ? properties.getShouldRefreshThreshold()
                                : shouldRefreshThreshold)
                .withMinThrottleTime(
                        properties.getMinThrottleTime() != null
                                ? properties.getMinThrottleTime()
                                : minThrottleTime)
                .withMaxThrottleTime(
                        properties.getMaxThrottleTime() != null
                                ? properties.getMaxThrottleTime()
                                : maxThrottleTime)
                .buildAuth0();
    }
}
