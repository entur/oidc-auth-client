...
/**
 * Builder class for constructing an instance of {@link AccessTokenFactory}. This builder allows
 * configuring various parameters related to token refresh thresholds, throttle times,
 * authentication credentials, and domain settings before constructing the factory.
 */
    ...
    protected void validateBuild() {
        if (mustRefreshThreshold != null || shouldRefreshThreshold != null) {
            ...
            if (mustRefreshThreshold >= shouldRefreshThreshold) {
                throw new IllegalArgumentException(
                        "Please specify blocking threshold as a lower value than non-blocking threshold");
            }
        }
        ...
        if (minThrottleTime != null || maxThrottleTime != null) {
            ...
            if (minThrottleTime >= maxThrottleTime) {
                throw new IllegalArgumentException(
                        "Please specify minimum throttle time as a lower value than maximum throttle time");
            }
        }
